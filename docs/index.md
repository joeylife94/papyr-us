...
> **코드 규모**: TypeScript ~33,000줄 | API 135개 | React 컴포넌트 94개 | DB 테이블 19개
...
| 2026-02-27 | Kanban 우선순위 색상 버그 수정, 모든 핸들러 스텁 → 실제 구현               |
| 2026-02-27 | 탭별 독립 쿼리 (lazy fetch), 갤러리 상태 탭별 분리, 컬럼 모듈 레벨 상수화  |
| 2026-02-27 | `table-view.tsx` 뱃지 배열 렌더링 지원                                     |
